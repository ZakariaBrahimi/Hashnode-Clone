                  ...
                  <div className=' col-start-1 col-end-[-1] flex  flex-col '>
                      ...
                      <form action="" className='flex flex-col '>
                        <label htmlFor="" className='font-semibold text-center'>
                          ...
                          <input className='w-full md:p-4 placeholder:font-normal outline outline-offset-2 border outline-2 outline-transparent p-3 mt-4 bg-white focus:border-[#3466f6] rounded-full' type="email" placeholder="Enter your email address" name="emailAddress" id="" />
                        </label>
                        <button className='border md:py-[0.625rem] md:w-auto border-[#3466f6] bg-blue-600 text-sm py-2 font-semibold w-full inline-flex items-center justify-center outline outline-transparent outline-offset-2 outline-2 mt-4 rounded-full self-center px-20 text-white'>Submit</button>
                      </form>
                  </div>
              </div>
          </div>
