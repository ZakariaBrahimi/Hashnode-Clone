...
const PasswordReset = () => {
	...
	return (
		...
		<div className='bg-[#fafbff]sm:max-w-[640px] h-10/12 md:max-w-[768px] lg:max-w-[1024px] lg:min-w-[0px] m-auto'>
			...
			<form onSubmit={(e)=>passwordReset(e)} action="" className='flex flex-col '>
		        <label htmlFor="" className='font-semibold text-center'>
		          <input className='w-full md:p-4 placeholder:font-normal outline outline-offset-2 border outline-2 outline-transparent p-3 mt-4 bg-white focus:border-[#3466f6] rounded-full' type="email" placeholder="Enter your Email" name="email" id="email_id" />
		        </label>
		        <h3 className='mt-2'>If you have already registred<span onClick={()=>console.log(false)} className='text-blue-600 cursor-pointer font-bold ml-1'>here</span> .</h3>
