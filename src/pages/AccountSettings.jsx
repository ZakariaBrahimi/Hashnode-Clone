  ...
  return (
    <div>
        ...
        <div class="flex flex-row items-end mb-2 overflow-auto text-sm font-bold text-gray-700 uppercase bg-white border rounded-lg whitespace-nowrap lg:items-start lg:flex-col dark:bg-gray-900 dark:border-gray-800 dark:text-gray-400">
            <a class="px-3 md:px-6 py-4 w-full flex flex-row items-center text-accent-blue-A700" href="/settings">
            ...
            <div class="flex flex-row flex-wrap">
                <div class="w-full lg:w-1/2 lg:pr-10">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" class="input-text " id="nameField" placeholder="Enter your full name" value="Zakaria Abdessamed Brahimi" />
                    </div>
                    <div class="mb-6">
                        <label for="tagline" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">Profile Tagline</label>
                        <input type="text" class="input-text" id="tagline" placeholder="Software Developer @ …" value="I am Django Back-end Developer looking for real-world opportunities" />
                    </div>
                    <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" class="input-text" id="location" placeholder="California, US" value="" />
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea type="text" class="input-text min-h-30" id="moreAboutYou" placeholder="I am a developer from …" ></textarea>
                </div>
                <div class="mb-6">
                    <label for="skills" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">Tech Stack</label>
                <div class="">
                <div class="relative mb-2">
                    <input type="text" class="input-text" id="skills" data-toggle="dropdown" placeholder="Search technologies, topics, more…" />
                ...
                <div class="flex flex-row flex-wrap">
                    <div class="button-primary small mr-2 mb-2 flex flex-row items-center">
                        <a href="0" class="mr-2">
                            <span>Python 3</span>
                        </a>
                        <button data-index="0">
        ...
        <div class="mb-6">
            ...
            <textarea type="text" class="input-text min-h-30 available-field" id="availableFor" placeholder="I am available for mentoring, …"></textarea>
    ...
    <div class="w-full lg:w-1/2">
        ...
        <div class="mb-6">
            ...
            <input type="url" pattern="(http|https)://twitter\.com\/(.+)|(http|https)://www\.twitter\.com\/(.+)" class="input-text }" id="twitter" placeholder="https://twitter.com/johndoe" value=""/>
        </div>
        <div class="mb-6">
            <label for="instagram" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">Instagram Profile</label>
            <input type="url" pattern="(http|https)://instagram\.com\/(.+)|(http|https)://www\.instagram\.com\/(.+)" class="input-text }" id="instagram" placeholder="https://instagram.com/johndoe" value="" />
        </div>
        <div class="mb-6">
            <label for="github" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">GitHub Profile</label>
            <input type="url" pattern="(http|https)://github\.com\/(.+)|(http|https)://www\.github\.com\/(.+)" class="input-text }" id="github" placeholder="https://github.com/hashnode" value="" />
        </div>
        <div class="mb-6">
            ...
            <input type="url" pattern="(http|https)://stackoverflow\.com\/(.+)|(http|https)://www\.stackoverflow\.com\/(.+)" class="input-text }" id="stackoverflow" placeholder="https://stackoverflow.com/users/22656/jon-skeet" value="" />
        </div>
        <div class="mb-6">
            <label for="facebook" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">Facebook Profile</label>
            <input type="url" pattern="(http|https)://facebook\.com\/(.+)|(http|https)://www\.facebook\.com\/(.+)|(http|https)://fb\.com\/(.+)|(http|https)://www\.fb\.com\/(.+)" class="input-text }" id="facebook" placeholder="https://facebook.com/johndoe" value="" />
        </div>
        <div class="mb-6">
            <label for="website" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">Website URL</label>
            <input type="url" class="input-text }" id="website" placeholder="https://johndoe.com" value="" />
        </div>
        <div class="mb-6">
            <label for="linkedin" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">LinkedIn URL</label>
            <input type="url" pattern="(http|https)://linkedin\.com\/in\/(.+)|(http|https)://www\.linkedin\.com\/in/(.+)|(http|https)://linkedin\.com\/company\/(.+)|(http|https)://www\.linkedin\.com\/company/(.+)" class="input-text }" id="linkedin" placeholder="https://www.linkedin.com/in/johndoe" value="" />
        </div>
        <div class="mb-6">
            <label for="youtube" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300">YouTube Channel</label>
            <input type="url" pattern="(http|https)://youtube\.com\/channel\/(.+)|(http|https)://www\.youtube\.com\/channel\/(.+)|(http|https)://youtube\.com\/c\/(.+)||(http|https)://www\.youtube\.com\/c\/(.+)|" class="input-text }" id="youtube" placeholder="https://www.youtube.com/channel/channel-name" value="" />
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                <input type="text" class="input-text " id="username" placeholder="" value="ZakariaBrahimi" />
        ...
        <div class="mb-6">
            ...
            <input type="email" class="input-text  " id="email" placeholder="" value="brahimi.zakaria.abdessamed@gmail.com" />
        </div>
        <div class="form-check">
            <label class="flex flex-row items-center mb-2 text-sm font-semibold text-gray-900 dark:text-gray-300" for="showEmail">
                <input type="checkbox" class="w-4 h-4 mr-2" value="" id="showEmail" />
            ...
            <div class="pt-4 mt-5">
                <button class="button-primary big">Update</button>
            </div>
        </div>
    </div>
  )
