    ...
    <div className="lg:w-[80vw] w-[98vw] sm:w-[88vw] md:w-[78vw] xl:w-[65vw]  mx-auto  mt-12 ">
        <div className="flex flex-col gap-8">
          <div className="text-[#334155] flex gap-4 relative">
            {/*Add Cover Box */}
            <div className={`${uploadImg ? 'flex' : 'hidden'} w-[80%] flex-col border absolute top-[100%] left-0 z-50 p-4 max-w-[450px] min-w-[320px] bg-white rounded-lg shadow-lg shadow-slate-200`}>
