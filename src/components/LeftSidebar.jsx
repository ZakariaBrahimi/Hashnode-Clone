    ...
    '>
      <div className='flex flex-col gap-4'>
        <div className='opacity-80 h-fit border-b pb-4 '>
          ...
          <a href="/" aria-label="My Feed" className="flex w-full px-4  gap-2 text-blue-600 font-semibold py-2 hover:bg-[#e5e7eb] border-r-2 border-r-blue-600">
          ...
          <a href="/explore" aria-label="Explore" className="flex gap-2 px-4  active:text-blue-600 font-medium py-2 hover:bg-[#e5e7eb] hover:border-r-2 hover:border-r-blue-600">
          ...
          <a href="/drafts" aria-label="Drafts" className="flex gap-2 px-4  active:text-blue-600 font-medium py-2 hover:bg-[#e5e7eb] hover:border-r-2 hover:border-r-blue-600">
          ...
          <a href="/bookmarks" aria-label="Bookmarks" className="flex gap-2 px-4  active:text-blue-600 font-medium py-2 hover:bg-[#e5e7eb] hover:border-r-2 hover:border-r-blue-600">
