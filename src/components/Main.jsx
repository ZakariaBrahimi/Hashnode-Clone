    ...
    <main className='h-screen w-screen lg:col-span-7 lg:w-full '>
        ...
        <div className='bg-white rounded-lg'>
            ...
            <div className='flex px-5 pt-3 border-b'>
                <a href="" className='flex px-2 py-3 gap-2 text-[#4b5563] border-b-blue-600 border-b-2 hover:bg-[#e5e7eb] rounded-t-lg mx-1'>
                ...
                <a href="" className='flex px-2 py-3 gap-2 text-[#4b5563] hover:bg-[#e5e7eb] rounded-t-lg mx-1'>
